...
#define extract_sparse_binpoly HAETAE_NAMESPACE(extract_sparse_binpoly)
void extract_sparse_binpoly(sppoly *out, const poly *in);

#define index_based_sparse_binary_challenge_polymult_modQ HAETAE_NAMESPACE(index_based_sparse_binary_challenge_polymult_modQ)
